...
> **Rules live in [`rules/`](./rules/).** This file routes; it never restates a rule. The assembled single-file view is [`../STANDARDS.md`](../STANDARDS.md) (generated — don't edit it).
